Contributing to CSPN Core
============================

The CSPN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/cspnpay/cspn/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the CSPN Core project (and related
projects such as libsecp256k1), and is not to be confused with overall CSPN
Network Protocol consensus changes.

Whether a pull request is merged into CSPN Core rests with the project merge
...
Patches that change CSPN consensus rules are considerably more involved than
...
Where a patch set proposes to change the CSPN consensus, it must have been
...
The review process is normally fairly responsive on the CSPN Core repository, however
...
The project leader is the release manager for each CSPN Core release.
