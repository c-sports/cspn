...
PUBKEY_ADDRESS_REGTEST = 98
SCRIPT_ADDRESS_REGTEST = 12
PRIVKEY = 46
PRIVKEY_TEST = 108
PRIVKEY_REGTEST = 108
...
bech32_templates = [
  ...
  ('bg',    0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('bg',    0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('bg',    1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tbg',   0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tbg',   0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tbg',   2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('bgrt',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('bgrt',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('bgrt', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tbg',  17, 32, False, False, False),
  ('bgrt',  3,  1, False, False, False),
  ('bg',   15, 41, False, False, False),
  ('tbg',   0, 16, False, False, False),
  ('bgrt',  0, 32, True,  False, False),
  ('bg',    0, 16, True,  False, False),
  ('tbg',   0, 32, False, True,  False),
  ('bgrt',  0, 20, False, False, True)
]
