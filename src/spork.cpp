...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_1_SUPERBLOCKS_ENABLED,            4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_2_RECONSIDER_BLOCKS,              4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_3_QUORUM_DKG_ENABLED,             4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_4_CHAINLOCKS_ENABLED,             4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_5_INSTANTSEND_ENABLED,            4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_6_INSTANTSEND_BLOCK_FILTERING,    4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_7_INSTANTSEND_AUTOLOCKS,          4070908800ULL), // OFF
