...
// Copyright (c) 2018-2019 The Bit Green Core developers
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/cspn"), tr("&About %1").arg(PACKAGE_NAME), this);
    ...
    toggleHideAction = new QAction(platformStyle->TextColorIcon(":/icons/cspn"), tr("&Show / Hide"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible CSPN command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to CSPN network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
