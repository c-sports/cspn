...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CSPN address"));
    ...
    privateSendCoinsAction->setStatusTip(tr("PrivateSend coins to a CSPN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cspn: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about CSPN Core"));
    ...
    decryptForStakingAction = new QAction(tr("&Decrypt Wallet for Staking Only"), this);
    decryptForStakingAction->setToolTip(tr("Decrypt wallet only for staking. Sending coins will still require the password."));
    lockWalletAction = new QAction(tr("&Lock Wallet"), this);
    signMessageAction = new QAction(tr("Sign &message..."), this);
    signMessageAction->setStatusTip(tr("Sign messages with your CSPN addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CSPN addresses"));
    ...
    openAction->setStatusTip(tr("Open a cspn: URI or payment request"));

    showHelpMessageAction = new QAction(tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible CSPN command-line options").arg(tr(PACKAGE_NAME)));
    ...
    if(walletFrame)
    {
        ...
        connect(decryptForStakingAction, SIGNAL(triggered()), walletFrame, SLOT(sunlockWallet()));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (fNetworkActive) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CSPN network", "", count));
    } else {
...
void BitcoinGUI::updateWidth()
{
    ...
    // Use nButtonsVisible + 1 <- for the cspn logo
...
{
    QString strTitle = tr("CSPN Core"); // default title
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unencrypted:
        ...
        decryptForStakingAction->setVisible(false);
    ...
    case WalletModel::UnlockedForStakingOnly:
        ...
        decryptForStakingAction->setVisible(true);
