    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  cspn-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the CSPN in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 CSPN, 0.01 CSPN, 0.1 CSPN, 1 CSPN and 10 CSPN -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%1\" href=\"https://docs.cspn.org/en/stable/wallets/cspncore/privatesend-instantsend.html\">PrivateSend documentation</a>."
