...
/* CSPNGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* CSPNGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
