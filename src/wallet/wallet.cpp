...
static bool ParseHDKeypath(const std::string& keypath_str, std::vector<uint32_t>& keypath)
{
...
CWallet* CWallet::CreateWalletFromFile(const std::string& name, const fs::path& path, uint64_t wallet_creation_flags)
{
