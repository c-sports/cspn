...
#ifndef CSPN_WALLET_WALLET_H
#define CSPN_WALLET_WALLET_H
...
public:
     ...
     * on this cspn node, and set to 0 for transactions that were created
...
public:
    ...
    int nStakeCombineThreshold GUARDED_BY(cs_wallet) = 0;
