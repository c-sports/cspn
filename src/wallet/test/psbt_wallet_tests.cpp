...
BOOST_AUTO_TEST_CASE(psbt_updater_test)
{
    ...
    // Add hd seed
    CKey key = DecodeSecret("2a6Rd6XtMKvFrjkDi6FcfSrJkpaKc382bCDadKjxPsSAHKXoZok"); // Mainnet and uncompressed form of cUkG8i1RFfWGWy5ziR11zJ5V4U4W3viSFCfyJmZnvQaUsd1xuF3T
