...
BENCHMARK(BLSPubKeyAggregate_Normal, 10)
BENCHMARK(BLSSecKeyAggregate_Normal, 10)
BENCHMARK(BLSSign_Normal, 10)
BENCHMARK(BLSVerify_Normal, 10)
BENCHMARK(BLSVerify_LargeBlock1000, 10)
BENCHMARK(BLSVerify_LargeBlockSelfAggregated1000, 10)
BENCHMARK(BLSVerify_LargeBlockSelfAggregated10000, 10)
BENCHMARK(BLSVerify_LargeAggregatedBlock1000, 10)
BENCHMARK(BLSVerify_LargeAggregatedBlock10000, 10)
BENCHMARK(BLSVerify_LargeAggregatedBlock1000PreVerified, 10)
BENCHMARK(BLSVerify_Batched, 10)
BENCHMARK(BLSVerify_BatchedParallel, 10)
