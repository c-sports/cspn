...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " cspn-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  cspn-tx [options] <hex-tx> [commands]  Update hex-encoded cspn transaction\n" +
            "or:     cspn-tx [options] -create [commands]   Create hex-encoded cspn transaction\n" +
            "\n";
