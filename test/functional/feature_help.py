...
"""Verify that starting cspn with -h works as expected."""

from test_framework.test_framework import CSPNTestFramework
from test_framework.util import assert_equal

class HelpTest(CSPNTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cspn with -h for help text")
        ...
        self.log.info("Start cspn with -version for version information")
        ...
        self.log.info("Start cspnd with -fakearg to make sure it does not start")
