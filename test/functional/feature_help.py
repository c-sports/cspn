...
"""Verify that starting cspnd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cspnd with -h for help text")
        ...
        self.log.info("Start cspnd with -version for version information")
