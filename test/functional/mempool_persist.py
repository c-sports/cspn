...
By default, cspnd will dump mempool on shutdown and
...
class MempoolPersistTest(CSPNTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent cspnd from writing mempool.dat to disk. Verify that `savemempool` fails")
