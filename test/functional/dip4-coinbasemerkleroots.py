...
class LLMQCoinbaseCommitmentsTest(CSPNTestFramework):
    def set_test_params(self):
        self.set_cspn_test_params(4, 3, fast_dip3_enforcement=True)
        self.set_cspn_dip8_activation(200)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as CSPNTestFramework doesn't support this atm)
