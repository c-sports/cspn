...
class BitcoinTestFramework():
    ...
    def main(self):
        ...
        parser.add_option("--srcdir", dest="srcdir", default=os.path.normpath(os.path.dirname(os.path.realpath(__file__)) + "/../../../src"),
                          help="Source directory containing cspnd/cspn-cli (default: %default)")
        ...
        parser.add_option("--cspnd-arg", dest="cspnd_extra_args", default=[], type='string', action='append',
                          help="Pass extra args to all cspnd instances")
        ...
        self.extra_args_from_options = self.options.cspnd_extra_args
    ...
    def assert_start_raises_init_error(self, i, extra_args=None, expected_msg=None, *args, **kwargs):
        with tempfile.SpooledTemporaryFile(max_size=2**16) as log_stderr:
            try:
                ...
                assert 'cspnd exited' in str(e)  # node must have shutdown
    ...
    def _initialize_chain(self, extra_args=None, stderr=None):
        ...
        if create_cache:
            ...
            # Create cache directories, run cspnds:
            self.set_genesis_mocktime()
            for i in range(MAX_NODES):
                datadir = initialize_datadir(self.options.cachedir, i)
                args = [os.getenv("CSPND", "cspnd"), "-server", "-keypool=1", "-datadir=" + datadir, "-discover=0", "-mocktime="+str(GENESISTIME)]
                if i > 0:
...
class CSPNTestFramework(BitcoinTestFramework):
    def set_cspn_test_params(self, num_nodes, masterodes_count, extra_args=None, fast_dip3_enforcement=False):
    ...
    def set_cspn_dip8_activation(self, activate_after_block):
    ...
    def set_cspn_llmq_test_params(self, llmq_size, llmq_threshold):
