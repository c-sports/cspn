...
* cspn.conf: contains configuration settings for cspnd or cspn-qt
* cspnd.pid: stores the process id of cspnd while running
...
* debug.log: contains debug information and general logging generated by cspnd or cspn-qt
