...
This document provides guidelines for internationalization of the CSPN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cspn_en.ts` remains unchanged.
