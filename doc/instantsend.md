...
This mechanism has been integrated into Bitcore-Node-CSPN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cspnpay/insight-api-cspn#web-socket-api](https://github.com/cspnpay/insight-api-cspn#web-socket-api)
* API: [https://github.com/cspnpay/insight-api-cspn#instantsend-transactions](https://github.com/cspnpay/insight-api-cspn#instantsend-transactions)
